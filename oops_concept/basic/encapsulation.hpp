...
inline void demonstrateEncapsulation() {
    std::cout << "\n===== ENCAPSULATION DEMO =====\n" << std::endl;
    ...
    // Employee system demonstration
    std::cout << "\n2. Employee Management System:" << std::endl;
    BasicConcepts::Employee emp1("Alice", "Johnson", "Engineering", 75000.0, 3);
    BasicConcepts::Employee emp2("Bob", "Smith", "Data Science", 80000.0, 5);
    
    emp1.displayInfo();
    emp2.displayInfo();
    
    std::cout << "Alice's salary: $" << emp1.getSalary() << std::endl;
    // Note: giveRaise method might not be implemented, showing basic encapsulation
    
    // Friend function demonstration
    std::cout << "\n3. Friend Function Access:" << std::endl;
    BasicConcepts::BankAccount friendAccount("Bob Smith", "9876543210", "4321", 2000.0);
    // auditAccount(friendAccount); // Friend function for internal access
}
