 ...
 * This shows how multiple source files are linked together using Make
 */
...
int main() {
    std::cout << "Welcome to the Calculator Demo - Make Build!" << std::endl;
    std::cout << "This project demonstrates the Make build system." << std::endl;
    
    demonstrateBasicOperations();
    demonstrateAdvancedOperations();
    demonstrateErrorHandling();
    
    printHeader("MAKE BUILD SYSTEM INFORMATION");
    std::cout << "This program was compiled using:" << std::endl;
    std::cout << "- Make build system with Makefile" << std::endl;
    std::cout << "- Header files from: include/ directory" << std::endl;
    std::cout << "- Source files from: src/ directory" << std::endl;
    std::cout << "- Traditional Unix/Linux build approach" << std::endl;
    std::cout << "- Direct g++ compiler control" << std::endl;
